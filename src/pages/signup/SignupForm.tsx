        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="grid grid-cols-2 gap-4" onSubmit={handleSubmit(onSubmit)}>
              <div>
                <label htmlFor="firstName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{t('First Name')}</label>
                ...
                {errors.firstName && <span className="text-red-500">{t('Please enter a valid first name')}</span>}
              </div>
              <div>
                <label htmlFor="lastName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{t('Last Name')}</label>
                ...
                {errors.lastName && <span className="text-red-500">{t('Please enter a valid last name')}</span>}
              </div>
              <div>
                <label htmlFor="username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{t('Username')}</label>
                ...
                {errors.username && <span className="text-red-500">{t('Username is required')}</span>}
              </div>
              <div>
              ...
              <div>
                <label htmlFor="mobileNumber" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{t('Mobile Number')}</label>
                ...
                {errors.mobileNumber && <span className="text-red-500">{t('Please enter a valid 10-digit mobile number')}</span>}
              </div>
              <div>
